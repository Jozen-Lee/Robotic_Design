...
{
	flash.Read(pBuffer, ReadAddr, NumByteToRead);
}

void W25QXX_Write(uint8_t* pBuffer,uint32_t ReadAddr,uint16_t NumByteToRead)
{
	flash.Write(pBuffer, ReadAddr, NumByteToRead);
}
